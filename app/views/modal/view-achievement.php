        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <div class="row" style="margin-right: 15px;">
                    <div class="col-xs-6">
                        <h4 class="modal-title" style="line-height: 30px;">
            ...
            <div class="modal-body">
                <div class="table-responsive">
                    <table id="tabla-modal-logros" class="table table-hover text-center">
                        <thead>
                            <tr>
            ...
            <div class="modal-footer">
                ...
                <button type="button" onclick="descargarPDF('TablaLogros')" class="btn btn-sm btn-raised btn-primary">
