...
<body>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" onclick="descargarPDF(salaActual)" class="btn btn-info btn-raised">
                        <i class="zmdi zmdi-print"></i> Descargar Informe
                    </button>
                </div>
            </div>
        </div>
    ...
    <script>
        ...
        function generarReportePorSala(data, sala) {
            ...
            // ==========================================
            // 3. PRÉSTAMO CIRCULANTE (Excluido para Referencia y Estatal)
            // ==========================================
            if (sala !== 'sala_referencia' && sala !== 'sala_estatal') {
                let totalPrestamosEjemplares = 0;
                for (let area in data.prestamosPorArea) {
                    totalPrestamosEjemplares += parseInt(data.prestamosPorArea[area]) || 0;
                }
